...
<template>
    ...
    <AppLayout>
        ...
        <template #header-actions>
            <Link
                href="/"
                class="text-xs text-slate-600 hover:text-emerald-700 px-2.5 py-1 transition font-medium"
            >
                &larr; Pencarian
            </Link>
        </template>
        ...
        <div class="py-4 space-y-6">
            ...
            <div class="text-center space-y-2">
                <div class="h-12 w-12 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-600 flex items-center justify-center mx-auto shadow-2xs">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 shadow-xs space-y-4">
                ...
                <div class="p-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 text-xs flex items-center justify-between gap-2">
                    <span>💡 Preview mode (masuk langsung ke dashboard)</span>
                    <button
                        type="button"
                        @click="fillDemoCredentials"
                        class="text-[11px] font-semibold text-emerald-700 hover:underline flex items-center gap-1 flex-shrink-0"
                    >
                ...
                <form @submit.prevent="handleLogin" class="space-y-4">
                    ...
                    <div class="flex items-center gap-2 pt-1">
                        ...
                        />
                        <label for="remember" class="text-xs text-slate-600 select-none cursor-pointer">
                    ...
                    <div class="pt-2">
                        <Button
                            ...
                            size="lg"
                            :disabled="isLoading"
                            class="w-full h-11 rounded-xl text-sm font-semibold shadow-xs"
                        >
